...
df = pd.read_sql("SELECT Raw_Data_ID, authors_with_affiliations FROM affiliations_ascii_cleaned;", conn)
...
for _, row in df.iterrows():
    raw_id = row['Raw_Data_ID']
    full_text = str(row['authors_with_affiliations'])
